...
namespace WzComparerR2
{
    public partial class MainForm : Office2007RibbonForm, PluginContextProvider
    {
        ...
        public static bool HasSkill001;
        public static bool HasMob001;
        public static AfrmTooltip tooltipRef;
        ...
        void ExpandNode(Wz_Node Node)
        {
            OnSelectedWzNode(Node);
            ...
            if (selectedNode != null)
            {
                ...
                try
                {
                    var node = createNodeDetail(advTree2.SelectedNode);
                    node.ExpandAll();
        ...
        public static void ExpandTreeNode(Wz_Node Node)
        {
            MainForm.Instance.ExpandNode(Node);
        ...
        private void loadUIState()
        {
            try
            {
                ...
                this.ribbonControl1.Expanded = true; // = false;
        ...
        public DevComponents.AdvTree.Node advTree1Node;
        private void openWz(string wzFilePath)
        {
            ...
            if (File.Exists(path + "\\Skill001.wz"))
                HasSkill001 = true;
            if (File.Exists(path + "\\Mob001.wz"))
                HasMob001 = true;
            ...
            try
            {
                ...
                Node node2 = createNode(wz.WzNode);
        ...
        public void quickView(Node Node)
        {

            quickView2(Node.AsWzNode());
        }

        public void quickView2(Wz_Node node)
        {
            ...
            if (!Wz.IsDataWz)
            {
                ...
                switch (wzf.Type)
                {
                    ...
                    case Wz_Type.Map:
                        if (selectedNode.Text.Length == 13)
                        {
                            if (Char.IsNumber(selectedNode.Text[0]) && Char.IsNumber(selectedNode.Text[8]))
                            {
                                var map = new Map();
                                Map.ImgNode = selectedNode;
                                obj = map;
                            }
                        }
                        break;
        ...
        DevComponents.DotNetBar.ButtonItem GMHandToolButton;
        DevComponents.DotNetBar.ButtonItem IconButton;
        DevComponents.DotNetBar.ButtonItem StringWzButton;
        DevComponents.DotNetBar.ButtonItem ListViewButton;
        ...
        {
            if (DB2Form.Instance == null)
                new DB2Form().Show();
            else
                DB2Form.Instance.Show();
        }
        ...
        void IconButtonClick(object sender, EventArgs e)
        {
            ...
            if (IconForm.Instance == null)
                new IconForm().Show();
            else
                IconForm.Instance.Show();
        }

        void StringWzButtonClick(object sender, EventArgs e)
        {
            if (PluginManager.FindWz(Wz_Type.Base) == null)
            {
                MessageBox.Show("Base.wz not opened");
            ...
            if (StringWzForm.Instance == null)
                new StringWzForm().Show();
            else
                StringWzForm.Instance.Show();
        }

        void ListViewButtonClick(object sender, EventArgs e)
        {
            if (PluginManager.FindWz(Wz_Type.Base) == null)
            {
                MessageBox.Show("Base.wz not opened");
            ...
            if (ListViewForm.Instance == null)
                new ListViewForm().Show();
            else
                ListViewForm.Instance.Show();
        }
        ...
        void DumpPngs(string FolderName, Wz_Node Entry)
        {
            if (Entry != null)
            {
                if (Entry.Value is Wz_Png || Entry.Value is Wz_Uol)
                    Wz.GetNode(Entry.FullPathToFile2()).ExtractPng().Save(FolderName + "\\" + Entry.GetPathD() + ".png");
                foreach (var E in Entry.Nodes)
                    if (!(E.Value is Wz_Image))
                        DumpPngs(FolderName, E);
            }
        }
        void SavePngButtonClick(object sender, EventArgs e)
        {
            ...
            if ((dlg.ShowDialog(new Form() { TopMost = true }) != DialogResult.OK))
                return;
            DumpPngs(dlg.SelectedPath, Wz.GetNode(SelectedNode.FullPathToFile2()));
        }
        ...
        void SearchWzButtonClick(object sender, EventArgs e)
        {
            ...
            if (SearchWzForm.Instance == null)
                new SearchWzForm().Show();
            else
                SearchWzForm.Instance.Show();
        }

        void MapObjButtonClick(object sender, EventArgs e)
        {
            if (PluginManager.FindWz(Wz_Type.Base) == null)
            {
                MessageBox.Show("Base.wz not opened");
            ...
            if (MapObjForm.Instance == null)
                new MapObjForm().Show();
            else
                MapObjForm.Instance.Show();
        }

        void ImageViewerButtonClick(object sender, EventArgs e)
        {
            if (PluginManager.FindWz(Wz_Type.Base) == null)
            {
                MessageBox.Show("Base.wz not opened");
            ...
            if (ImageViewerForm.Instance == null)
                new ImageViewerForm().Show();
            else
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            GMHandToolButton = new DevComponents.DotNetBar.ButtonItem();
            GMHandToolButton.Text = "GMHandTool";
            GMHandToolButton.FixedSize = new Size(95, 65);
            GMHandToolButton.Click += new System.EventHandler(this.DB2ButtonClick);
            var RibbonBarDB2 = new DevComponents.DotNetBar.RibbonBar();
            RibbonBarDB2.MinimumSize = new Size(95, 50);
            RibbonBarDB2.Location = new Point(1210, 10);
            RibbonBarDB2.Text = "GM HandTool";
            RibbonBarDB2.Items.Add(GMHandToolButton);
            this.ribbonPanel1.Controls.Add(RibbonBarDB2);
            //
            IconButton = new DevComponents.DotNetBar.ButtonItem();
            IconButton.Text = "  Icons";
            IconButton.FixedSize = new Size(60, 65);
            IconButton.Click += new System.EventHandler(this.IconButtonClick);
            var RibbonBarIcons = new DevComponents.DotNetBar.RibbonBar();
            RibbonBarIcons.MinimumSize = new Size(70, 50);
            RibbonBarIcons.Location = new Point(1410, 10);
            RibbonBarIcons.Text = "Icons";
            RibbonBarIcons.Items.Add(IconButton);
            this.ribbonPanel1.Controls.Add(RibbonBarIcons);
            //
            StringWzButton = new DevComponents.DotNetBar.ButtonItem();
            StringWzButton.Text = "String.Wz";
            StringWzButton.FixedSize = new Size(70, 65);
            StringWzButton.Click += new System.EventHandler(this.StringWzButtonClick);
            var RibbonBarStringWz = new DevComponents.DotNetBar.RibbonBar();
            RibbonBarStringWz.MinimumSize = new Size(80, 50);
            RibbonBarStringWz.Location = new Point(1410, 10);
            RibbonBarStringWz.Text = "String.Wz";
            RibbonBarStringWz.Items.Add(StringWzButton);
            this.ribbonPanel1.Controls.Add(RibbonBarStringWz);
            //
            ListViewButton = new DevComponents.DotNetBar.ButtonItem();
            ListViewButton.Text = "ListView";
            ListViewButton.FixedSize = new Size(70, 65);
            ListViewButton.Click += new System.EventHandler(this.ListViewButtonClick);
            var RibbonBarListView = new DevComponents.DotNetBar.RibbonBar();
            RibbonBarListView.MinimumSize = new Size(80, 50);
            RibbonBarListView.Location = new Point(1410, 10);
            RibbonBarListView.Text = "ListView";
            RibbonBarListView.Items.Add(ListViewButton);
            this.ribbonPanel1.Controls.Add(RibbonBarListView);
            //
            SavePngButton = new DevComponents.DotNetBar.ButtonItem();
            SavePngButton.Text = "Batch Save Pngs";
            SavePngButton.FixedSize = new Size(114, 65);
            SavePngButton.Click += new System.EventHandler(this.SavePngButtonClick);
            var SavePngRibbonBar = new DevComponents.DotNetBar.RibbonBar();
            SavePngRibbonBar.Location = new Point(1410, 10);
            SavePngRibbonBar.Text = "Save Pngs";
            SavePngRibbonBar.MinimumSize = new Size(80, 50);
            SavePngRibbonBar.Items.Add(SavePngButton);
            this.ribbonPanel1.Controls.Add(SavePngRibbonBar);
            //
            SearchWzButton = new DevComponents.DotNetBar.ButtonItem();
            SearchWzButton.Text = "Search Wz";
            SearchWzButton.FixedSize = new Size(84, 65);
            SearchWzButton.Click += new System.EventHandler(this.SearchWzButtonClick);
            var SearchWzRibbonBar = new DevComponents.DotNetBar.RibbonBar();
            SearchWzRibbonBar.Location = new Point(1610, 10);
            SearchWzRibbonBar.Text = "Search Wz";
            SearchWzRibbonBar.MinimumSize = new Size(65, 50);
            SearchWzRibbonBar.Items.Add(SearchWzButton);
            this.ribbonPanel1.Controls.Add(SearchWzRibbonBar);
            //
            MapObjButton = new DevComponents.DotNetBar.ButtonItem();
            MapObjButton.Text = "Map Objs";
            MapObjButton.FixedSize = new Size(78, 65);
            MapObjButton.Click += new System.EventHandler(this.MapObjButtonClick);
            var MapObjRibbonBar = new DevComponents.DotNetBar.RibbonBar();
            MapObjRibbonBar.Location = new Point(1710, 10);
            MapObjRibbonBar.Text = "Map Objs";
            MapObjRibbonBar.MinimumSize = new Size(69, 50);
            MapObjRibbonBar.Items.Add(MapObjButton);
            this.ribbonPanel1.Controls.Add(MapObjRibbonBar);
            //
            ImageViewerButton = new DevComponents.DotNetBar.ButtonItem();
            ImageViewerButton.Text = "Pic Viewer";
            ImageViewerButton.FixedSize = new Size(78, 65);
            ...
            ImageViewerRibbonBar.Text = "Pic Viewer";
