    ...
    public class GearTooltipRender2 : TooltipRender
    {
        ...
        public override Bitmap Render()
        {
            ...
            if (left != null)
            {
                ...
                //复制图像
                g.DrawImage2(left, width, 0, new Rectangle(0, 0, left.Width, picH[0]), GraphicsUnit.Pixel);
            ...
            if (genesis != null || set != null)
            {
                ...
                if (genesis != null)
                {
                    ...
                    g.DrawImage2(res["b"].Image, width, genesisHeight - 13);

                    // copy text layer
                    var genesis2 = genesis;
                    genesis2.SetResolution(DPIUtil.dpiX, DPIUtil.dpiY);
                    g.DrawImage(genesis2, width, 0, new Rectangle(0, 0, genesis.Width, genesisHeight), GraphicsUnit.Pixel);
                ...
                if (set != null)
                {
                    ...
                    g.DrawImage(set2, width, y, new Rectangle(0, 0, set.Width, setHeight), GraphicsUnit.Pixel);
            ...
            if (levelOrSealed != null)
            {
                ...
                g.DrawImage(levelOrSealed2, width, 0, new Rectangle(0, 0, levelOrSealed.Width, picH[3]), GraphicsUnit.Pixel);
        ...
        private Bitmap RenderBase(out int picH)
        {
            ...
            if (Gear.IconRaw.Bitmap != null) //绘制icon
            {
                ...
                g.DrawImage2(shade,
                    ...
                    attr);
                //绘制图标
                g.DrawImage2(GearGraphics.EnlargeBitmap(Gear.IconRaw.Bitmap),
            ...
            if (optionCount > 0)
            {
                ...
                g.DrawImage2(GetAdditionalOptionIcon(Gear.Grade), 9, picH - 2);
            ...
            if (adOptionCount > 0)
            {
                ...
                g.DrawImage2(GetAdditionalOptionIcon(Gear.AdditionGrade), 9, picH - 2);
